...
const SignUp = ( {onSwitchMode}) => {
  ...
  const handleSubmit = async (e) =>{
    ...
    try {
      ...
      setMessage({
        text:"registration successfully you can now log in",
        type:"success"
      })
      ...
      console.log("signup error check signup.jsx",error)
      setMessage({
        text:error.response?.data?.message || "an error occored please try again ",type:"error"
      })
    }
  ...
  return (
    <div className='max-w-md w-full bg-white shadow-lg border border-purple-100 rounded-xl p-8'>
      ...
      {/* You can place your form and message display logic here */}
      {message.text && (
